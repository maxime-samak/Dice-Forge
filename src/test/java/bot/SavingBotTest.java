...
public class SavingBotTest {
    ...
    public void getPreferredResource() {
        ...
        ScoreCounter.updateScore(bot1.getBotScore(), new DiceCard[]{new DiceCard(1, Resource.SOLAR), new DiceCard(1, Resource.GOLD)});
        ...
        ScoreCounter.updateScore(bot1.getBotScore(), new DiceCard[]{new DiceCard(1, Resource.LUNAR), new DiceCard(0, Resource.GOLD)});
