...
public class BuyDiceCardTest {
    ...
    public void BuyDiceCardTest()
    {
        ...
        ScoreCounter.updateScore(bot.getBotScore(),"1@GOLD%1@GOLD");
        ...
        ScoreCounter.updateScore(bot.getBotScore(),"2@GOLD%1@GOLD");
        ...
        ScoreCounter.updateScore(bot.getBotScore(),"3@GOLD%3@GOLD");
        ...
        ScoreCounter.updateScore(bot.getBotScore(),"4@GOLD%4@GOLD");
