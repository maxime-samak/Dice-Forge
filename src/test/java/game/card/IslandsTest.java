...
public class IslandsTest {
    ...
    public void IslandsTest() {
        ...
        String s1 = "[Vous pouvez dépensez 3 gold pour gagner 4 point gloire à tous les tours jusqu'à la fin., Vous pouvez dépensez 3 gold pour gagner 4 point gloire à tous les tours jusqu'à la fin.]";
